  ...
  //  foreach($username as $line)
     for($i=$start;$i<=$limit;$i++)
     {
                  ...
                  //  $popup = strcpy($username[$i]);
                    ...
                    echo "<table>
                      <tr>
                        <td  style='padding: 15px;'><div class=".$popup."><button id='".$lineext."' value='like' onclick='like(this.id,this.value)' class='btn btn-sm btn-outline-secondary ' onmouseover='myFunction()' onmouseout='myFunction()' style='background-color:transparent !important; border: none;    cursor:pointer;    overflow: hidden;    outline:none;' type='button' name='button'><i class='far fa-thumbs-up'></i>  like</button>
                        <span class=".$popuptext." id='mypopup'>Like</span>
                        </div>
                        </td>
